...
CONTINUATION_CASES = {"002-summary-followup", "007-coffee-stop", "018-undo-redo"}
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Execute the 20 semantic cases through OpenAI provider-native remote MCP.")
